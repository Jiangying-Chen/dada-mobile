<template>
	<view class="container">
		...
		<view class="icon-container">
			<image class="input-icon" @tap="openDrawer(1)" src="@/static/im/emoji.png"></image>
			<image class="input-icon" @tap="selectImage()" src="@/static/im/image.png"></image>
			<image class="input-icon" @tap="selectVideo()" src="@/static/im/video.png"></image>
			...
			<lsj-upload
				...
				@change="fileOnChange"
			>
				<image  class="input-icon" src="@/static/im/file.png"></image>
			</lsj-upload>
			<!-- #endif -->
			<!-- #ifdef H5 -->
			<image class="input-icon" @tap="selectFile()" src="@/static/im/file.png"></image>
			<!-- #endif -->
		</view>
		...
		<view class="file-container" v-if="selectedFile!==null">
			<view>
				<image style="width: 100rpx;height: 100rpx;margin-top: 60rpx;" src="@/static/im/clip.png"></image>
