	...
	export default {
		data() {
			return {
				...
				items: [{
					id: 0,
					icon: 'https://pic.linfeng.tech/test/20230201/cc431168b02648ffad29b0e10f98c0be.png',
					title: '支付宝',
				}, {
					id: 1,
					icon: 'https://pic.linfeng.tech/test/20230201/b5269ec2283a4a46be16e9af5365b106.png',
					title: '微信',
				}],
				current: 0,
